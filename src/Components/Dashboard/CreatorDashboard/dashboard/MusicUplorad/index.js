...
const MusicUplorad = () => {
  ...
  console.log("prisingStep", prisingStep);
//   useEffect(() => {
//     const storedPrisingStep = () => {
//       const storedPrisingSteps = localStorage.getItem("pricingStep");
//       if (storedPrisingSteps) {
//         setPrisingStep(storedPrisingSteps);
//       }
//     };
//     storedPrisingStep();
