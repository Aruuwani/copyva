...
const UploardContent = () => {
  ...
  return (
    <div className="step_part">
      ...
      <div className="stepForm_part">
        <div
          className={`step_divForm ${currentStep > 1 ? "stepCompleted" : ""}`}
        >
          <p
        ...
        <div
          className={`step_divForm ${currentStep > 2 ? "stepCompleted" : ""}`}
        >
          <p
        ...
        <div
          className={`step_divForm ${currentStep > 3 ? "stepCompleted" : ""}`}
        >
          <p
        ...
        <div
          className={`step_divForm ${currentStep > 4 ? "stepCompleted" : ""}`}
        >
          <p
      ...
      <div className="col-md-6 custom-form">
        ...
        <div className="musicSubmitbtn">
          {currentStep < 5 && currentStep !== 3 && (
            <button className="musicSubmitbutton" onClick={handleNext}>
              Submit
            </button>
          )}
      ...
      <div className="note_sec">
        <h1>Note</h1>
        <p>
          Since our customers buy a license for each song, we suggest you set an
          affordable price.
        </p>
      </div>
    </div>
