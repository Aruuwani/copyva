    ...
    return (
      ...
      <Tabs selectedIndex={tabIndex} onSelect={(index) => setTabIndex(index)}>
        <TabList classID='tab_list'>
          ...
          <Tab><h4><img src={Content_img} alt='Content_img' />Content</h4></Tab>
          <Tab><h4><img src={Artist_img} alt='Artist_img' />Artist</h4></Tab>
        </TabList>
        <TabPanel><div className='Tab_content'>
          <div><img src={First_tab} alt=''/></div>
          <div><img src={Sec_tab} alt=''/></div>
          <div><img src={Third_tab} alt=''/></div>
          <div><img src={Fourth_tab} alt=''/></div>
          <div><img src={Five_img} alt=''/></div>
          <div><img src={Six_img} alt=''/></div>
          </div></TabPanel>
      ...
      <button type='btn' className='btn_one'>View all</button>
      </section>
    );
}
